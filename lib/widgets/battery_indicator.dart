  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      Expanded(
          flex: 4,
          child: CustomPaint(
            painter: _BatteryLevelPainter(getDatabaseValue(widget.dataKey, widget.min), this, widget.min, widget.max, widget.high, widget.low),
            size: widget.size,
            willChange: true,
          )),
      Flexible(child: widget.data != null ? widget.data! : const Padding(padding: EdgeInsets.all(1))),
    ]);
  }
}
